...
faces,ids = getImagesAndLabels(r'C:\Users\Anandh\mp1\Unlocking-PC-using-Facial-Recognition\dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists(r'C:\Users\Anandh\mp1\Unlocking-PC-using-Facial-Recognition\trainer.py')    # Save the model into trainer.yml
recognizer.save(r'trainer.yaml')
