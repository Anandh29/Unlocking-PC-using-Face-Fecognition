...
assure_path_exists(r"C:\Users\Anandh\mp1\Unlocking-PC-using-Facial-Recognition\training_model.py")

recognizer.read(r"C:\Users\Anandh\mp1\Unlocking-PC-using-Facial-Recognition\trainer.yaml")  #load training model

cascadePath = r"haarcascade_frontalface_default.xml"  #cascade path
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(confidence>80):                 #confidence usually comes greater than 80 for strangers
            ...
            Id = "UNLOCK PC + {0:.2f}%".format(round(100 - confidence, 2)) 
            print("Verified")
            print(confidence)
            counter_correct += 1
